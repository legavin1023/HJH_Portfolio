<template>
  ...
  >
    <ul
      class="flex justify-between items-center h-[60px] mr-[36px] ml-[36px] font-extrabold text-base"
    >
      ...
      <li
        class="cursor-pointer text-sm px-[21px] py-[9.5px] rounded-full hover:bg-black-b200 bg-black-b700 text-black-b00"
