<template>
  <button
    :disabled="!liveUrl"
    class="flex justify-between items-center pl-[26px] pr-[16px] w-[200px] h-[46px] rounded-full text-[16px] text-center leading-[46px] transition-colors duration-300 ease-in-out"
    :class="[
      !liveUrl
        ? 'bg-black-b40 text-black-b80 cursor-not-allowed'
        : 'bg-black-b700 text-black-b00 hover:bg-black-b600',
    ]"
    @click="handleClick"
  >
    <slot></slot>
