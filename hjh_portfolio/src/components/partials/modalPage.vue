<template>
  ...
  >
    <div class="relative overflow-y-scroll w-full h-full">
      <div
        class="absolute top-[42px] bg-black-b900 w-full mobile:w-[100%] tablet:w-[1024px] lg:w-[1400px] mx-auto h-auto rounded-t-[10px]"
      ...
      >
        <div class="sticky">
          ...
          >
            <div
              class="flex items-center pl-[44px] pt-[30px] pb-[20px] mobile:pl-[20px] mobile:pt-[15px] mobile:pb-[10px] tablet:pl-[30px] tablet:pt-[20px] tablet:pb-[15px]"
            >
              <img
                :src="content.companyLogo"
                alt="Company Logo"
                class="w-[60px] h-[60px] mobile:w-[40px] mobile:h-[40px] tablet:w-[50px] tablet:h-[50px] rounded-full bg-black-b50"
              />
              <div class="ml-[22px] mobile:ml-[10px] tablet:ml-[15px]">
                <p
                  class="text-[26px] mobile:text-[18px] tablet:text-[22px] font-700"
                >
                  {{ content.name }}
                </p>
                <p class="text-[16px] mobile:text-[14px] tablet:text-[15px]">
                  {{ content.description }}
                </p>
              </div>
            </div>
          ...
          <div
            class="w-full h-[86px] mobile:h-auto tablet:h-[70px] flex items-center justify-between pl-[50px] pr-[43px] mobile:pl-[20px] mobile:pr-[20px] tablet:pl-[30px] tablet:pr-[30px] bg-green-p25 border-t-black-b50 border-t-[1px]"
          >
            <div
              class="flex flex-col tablet:flex-row flex-wrap justify-start tablet:items-center items-start"
            >
              <p class="mb-[10px] mobile:mb-[5px] tablet:mb-[8px]">
                <EmphasisSpan>작업기간</EmphasisSpan>
                <span
                  class="ml-[10px] mr-[36px] text-[14px] mobile:text-[12px] tablet:text-[13px]"
                >
                  {{ content.date }}
                </span>
              </p>
        ...
        <div class="w-full flex justify-center">
          <img
            ...
            alt="Modal Image"
            class="bg-black-b00 max-w-none h-auto w-[100%] mobile:w-[90%] tablet:w-[80%]"
          />
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    closeIcon() {
      ...
      return this.windowWidth <= 1024 ? closeLineIcon : closeIcon;
    },
  },
  methods: {
    closeModal() {
